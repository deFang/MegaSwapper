...
describe('MegaSwapper', function () {
    ...
    it('swap', async function () {
        ...
        txdata = await getTxdata(usdc_address, 6, wbtc_address, 8, decimalStrUSDT("1000"), 1, megaswapper.address, signer)
        ...
        await megaswapper.connect(signer).swap(usdc_address, wbtc_address, decimalStrUSDT("1000"), true, executor_address, executor_data)
